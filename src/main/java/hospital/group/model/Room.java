...
public class Room {
	...
	public Room(String roomId, String roomNumber, String roomType, String availabilityStatus, String assignedPatientId,
			int floorNumber, String departmentId, String lastCleanedAt, double dailyRate) {
		super();
		this.roomId = roomId;
